<?php 
  ...
  $list->setValorId($_GET["idEditar1"]); // metodo para pega da url 
...
<input type="hidden" name="txtLocal" value="Redefinir_Senha">
<input type="hidden" name="id_usuario" value="<?=$reg->id_usuario?>">
<fieldset>
   <legend> <h3>Redefinir Senhar</h3></legend>
...
<center>        
            ...
            <button id="btsalvar" name="txtLocal" value="Redefinir_Senha" type="submit" onclick="return validar()" class="btn btn-success">Editar</button>
            </div>
    </center>
