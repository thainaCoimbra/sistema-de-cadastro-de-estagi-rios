...
<div id="lista_container" style="display: none;">

</div>

<div class="container" id="usuario">
    <form class="form-horizontal" name="formuser" method="post" id="cadUsuario">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            ...
                            <input name="txtLocal" class="hidden" value="Cadastrar">
                        </div>
...
<script>
    ...
    $('#btsalvar').click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '/usuario/acoes/crud_usuario.php',
            async: true,
            data: dados,
            success: function(response) {
                swal("Cadastro Bem-Succedido", "Cadastro efetuado com sucesso", "success");

                carrega_lista();

            },
            error: function (response) {
                swal("ERRO", "Erro ao se conectar com a base de dados "+response+"", 'error');
            }
        }).then();
    ...
    function carrega_lista() {
                ...
                //$("#index_element").fadeToggle();
                $("#usuario").fadeToggle();
                $.ajax({
                    type: "GET",
                    url: "http://localhost/estagio/index.php?url=usuario/listar_usuario",
                    dataType: "html",
                    success: function(response){
                        $("#lista_container").html($(response).find("#lista")).fadeIn(1600);
                        setTimeout(function () {
                            $("#lista_container").show();
                        },1600);
                    }
